...
const Contact = () => {
  return (
    <>
      <section className="bg-slate-200 py-20 lg:py-[52px] overflow-hidden relative z-10">
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                Connect with us effortlessly. We're here to listen, assist, and engage. Your questions and feedback matter, and we're just a message away. Let's start a conversation today.
                </p>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 rounded-lg shadow-lg sm:p-12">
                <Fade right>
                <form>
                  <ContactInputBox
                    type="text"
